...
-- COMENÇANDO COM PRINCIPIOS DE MACHINE LEARNG
...
SELECT nome, cargo,
    CASE
        WHEN cargo = 'Financial Advisor' THEN 'CONDICAO 1'
        WHEN cargo = 'Director of Sales' THEN 'CONDICAO 2'
...
-- CONCEITOS PRINCIPAIS DE FILTROS
...
SELECT CONCAT(cargo, ' -- ', departamento) AS CARGO_COMPLETO
FROM funcionarios;
