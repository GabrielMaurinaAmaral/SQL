...
-- criando uma tabela geral das 3 tabelas
...
-- mandando um copia para determinada pasta
COPY REL_LOCADORA TO
'C:\CODE\PraticaBasica\SQL\Praticas_Podtgres_SQL\REL_LOCADORA.csv'
DELIMITER ';'
CSV HEADER;
...
/*
Para este desafio você precisa criar uma 
instrução SELECT, esta instrução SELECT usará
um IN para verificar se um departamento teve 
uma venda com preço superior a 90,00 dólares.

MAS o sql DEVE usar a instrução WITH que será
usada para selecionar todas as colunas de 
sales onde o preço for maior que 90,00, você 
deve chamar esta subconsulta special_sales.
*/
